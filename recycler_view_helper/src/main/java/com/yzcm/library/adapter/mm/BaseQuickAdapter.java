 ...
 */
package com.yzcm.library.adapter.mm;
...
import com.yzcm.library.adapter.mm.animation.AlphaInAnimation;
import com.yzcm.library.adapter.mm.animation.BaseAnimation;
import com.yzcm.library.adapter.mm.animation.ScaleInAnimation;
import com.yzcm.library.adapter.mm.animation.SlideInBottomAnimation;
import com.yzcm.library.adapter.mm.animation.SlideInLeftAnimation;
import com.yzcm.library.adapter.mm.animation.SlideInRightAnimation;
import com.yzcm.library.adapter.mm.entity.IExpandable;
import com.yzcm.library.adapter.mm.loadmore.LoadMoreView;
import com.yzcm.library.adapter.mm.loadmore.SimpleLoadMoreView;
import com.yzcm.library.adapter.mm.util.MultiTypeDelegate;
...
public abstract class BaseQuickAdapter<T, K extends BaseViewHolder> extends RecyclerView.Adapter<K> {
    ...
    private boolean addLoadMoreView = false;
    ...
    public void setData(@IntRange(from = 0) int index, @NonNull T data) {
        ...
        notifyItemChanged(index + getHeaderLayoutCount(),data);
    }
    ...
    public void setAddLoadMoreView(boolean addLoadMoreView) {
        this.addLoadMoreView = addLoadMoreView;
    }
